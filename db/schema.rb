...
ActiveRecord::Schema.define(version: 2023_11_04_042719) do
  ...
  create_table "tags", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_id", "item_tag_id"], name: "index_tags_on_item_id_and_item_tag_id", unique: true
    t.index ["item_id"], name: "index_tags_on_item_id"
    t.index ["item_tag_id"], name: "index_tags_on_item_tag_id"
  end
  ...
  add_foreign_key "tags", "item_tags"
